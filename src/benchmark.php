...
{
    $deferred = new Deferred();
    $GLOBALS['client']->get("https://covid-19-data.p.rapidapi.com/country?name=$code", [
...
{
    $loop->addPeriodicTimer(0.5, function () use (&$seconds) {
        $GLOBALS['timer'] += 0.5;
...
$countries = ["Belgium", "Italy", "France", "Germany", "Netherlands", "Brazil", "China", "Japan", "Canada", "Australia"];
